...
3	Base de Datos	PostgreSQL	Soporta funciones nativas y disparadores solicitados.
...
8	Seguridad	JSON Web Token / Bcrypt	Manejo seguro de PII y autenticación robusta evitando exponer datos sensibles.
