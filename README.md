...
| Base de Datos    | PostgreSQL   | Soporta funciones nativas y disparadores solicitados. |
| ORM              | Prisma       | Proporciona un esquema tipado, manejo de migraciones y abstracción de la base de datos. |
| Gestión de Colas | BullMQ       | Procesamiento asíncrono persistente y distribuido. |
...
## 1️⃣ Levantar contenedores (Docker)

```bash
make run
```

## 2️⃣ Inicializar esquema de base de datos e índices
